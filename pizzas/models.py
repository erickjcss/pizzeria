...
class Pizzas(models.Model):
    ...
    """ tendr'ia q hacer otra tabla usuario e interrelacionar su criterio con la oferta para saber la cantidad q valoran bien, mal, etc     calificacion=models.CharField(max_length=90,default="Sin calificar",blank=True) """
def __str__(self):
    return self.nombre